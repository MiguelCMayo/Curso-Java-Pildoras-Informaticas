...
public class StylesCss extends Application {
	...
	public void start(Stage primaryStage) {
				...
				lbNombre.getStyleClass().add("mi_estilo_propio");
		        ...
		        //RADIOBUTTON ELEGIR EL ESTILO DE LA PAGINA
				...
				HBox paneBotones = new HBox(20, botonOk, botonCancelar, paneStyle);
